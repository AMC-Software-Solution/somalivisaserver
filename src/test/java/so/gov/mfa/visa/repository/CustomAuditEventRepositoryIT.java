...
import so.gov.mfa.visa.config.audit.AuditEventConverter;
import so.gov.mfa.visa.domain.PersistentAuditEvent;
...
import static so.gov.mfa.visa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
