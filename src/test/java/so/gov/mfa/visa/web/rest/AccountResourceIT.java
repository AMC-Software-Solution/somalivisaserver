...
import so.gov.mfa.visa.config.Constants;
import so.gov.mfa.visa.domain.User;
import so.gov.mfa.visa.repository.AuthorityRepository;
import so.gov.mfa.visa.repository.UserRepository;
import so.gov.mfa.visa.security.AuthoritiesConstants;
import so.gov.mfa.visa.service.UserService;
import so.gov.mfa.visa.service.dto.PasswordChangeDTO;
import so.gov.mfa.visa.service.dto.UserDTO;
import so.gov.mfa.visa.web.rest.vm.KeyAndPasswordVM;
import so.gov.mfa.visa.web.rest.vm.ManagedUserVM;
...
import static so.gov.mfa.visa.web.rest.AccountResourceIT.TEST_USER_LOGIN;
