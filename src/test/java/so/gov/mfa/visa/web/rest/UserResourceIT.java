...
import so.gov.mfa.visa.domain.Authority;
...
import so.gov.mfa.visa.service.mapper.UserMapper;
...
public class UserResourceIT {
     ...
     *
     * @see so.gov.mfa.visa.repository.search.UserSearchRepositoryMockConfiguration
     */
    @Autowired
